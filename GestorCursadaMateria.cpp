...
void GestorCursadaMateria::iniciar()
{
    ...
    // 1. Loop principal
    string tituloMenu = "\n=====================================\n** Gestion de Cursadas de Materias **\n=====================================";
    ...
    while (opc != 0)
    {
        ...
        case 0:
            break;
        case 1:
        {   Archivo<Cuatrimestre> archivoCuatrimestres("Archivos/datos/cuatrimestre.dat");
            ...
            altaCursadaMateriaPorConsola();
             ...
             _mensajero.mensajeAdvertencia("Para Agregar Materias al Cuatrimestre debe tener un cuatrimestre en curso ");
            }
            break;
...
void GestorCursadaMateria::altaCursadaMateriaPorConsola()
{
    ...
    else
    {
        ...
        GestorCuatrimestre actualizacion("Archivos/datos/cursada_materias.dat");
        actualizacion.actualizarMateriasEnCursoEnCuatrimestre();
        _mensajero.mensajeInformacion("Cuatrimestre Actualizado Exitosamente");
